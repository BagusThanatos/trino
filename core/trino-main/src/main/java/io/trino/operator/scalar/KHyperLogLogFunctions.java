...
public final class KHyperLogLogFunctions
{
    ...
    @ScalarFunction
    @Description("Compute the cardinality of a KHyperLogLog instance")
    @SqlType(StandardTypes.BIGINT)
    public static long cardinality(@SqlType(StandardTypes.KHYPER_LOG_LOG) Slice serializedHll)
    {
        return HyperLogLog.newInstance(serializedHll).cardinality();
    }

    @ScalarFunction
    @Description("An empty KHyperLogLog instance")
    @SqlType(StandardTypes.KHYPER_LOG_LOG)
