...
{
    public static final KHyperLogLogType KHYPER_LOG_LOG = new KHyperLogLogType();

    @JsonCreator
    public KHyperLogLogType()
    {
        super(new TypeSignature(StandardTypes.KHYPER_LOG_LOG), Slice.class);
    }
