...
import static io.trino.plugin.thrift.api.TrinoThriftBlock.kHyperLogLogData;
 ...
 */
@ThriftStruct
public final class TrinoThriftKHyperLogLog
        implements TrinoThriftColumnData
{
    private final SliceData sliceType;

    @ThriftConstructor
    public TrinoThriftKHyperLogLog(
    ...
    {
        checkArgument(KHYPER_LOG_LOG.equals(desiredType), "type doesn't match: %s", desiredType);
    ...
    public boolean equals(Object obj)
    {
        ...
        TrinoThriftKHyperLogLog other = (TrinoThriftKHyperLogLog) obj;
    ...
    {
        return fromSliceBasedBlock(block, KHYPER_LOG_LOG, (nulls, sizes, bytes) -> kHyperLogLogData(new TrinoThriftKHyperLogLog(nulls, sizes, bytes)));
    }
}
